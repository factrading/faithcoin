Contributing to Fac Core
============================

The Fac Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Fac Core project, and is not to be
confused with overall Fac Network Protocol consensus changes.

Whether a pull request is merged into Fac Core rests with the project merge
...
Patches that change Fac consensus rules are considerably more involved than
...
Where a patch set proposes to change the Fac consensus, it must have been
...
The project leader is the release manager for each Fac Core release.

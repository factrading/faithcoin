...
RESOURCES += src/qt/fac.qrc src/qt/fac_locale.qrc

TRANSLATIONS += src/qt/locale/fac_bg.ts \
                src/qt/locale/fac_de.ts \
                src/qt/locale/fac_en.ts \
                src/qt/locale/fac_es.ts \
                src/qt/locale/fac_fi.ts \
                src/qt/locale/fac_fr.ts \
                src/qt/locale/fac_it.ts \
                src/qt/locale/fac_ja.ts \
                src/qt/locale/fac_pl.ts \
                src/qt/locale/fac_pt.ts \
                src/qt/locale/fac_ru.ts \
                src/qt/locale/fac_sk.ts \
                src/qt/locale/fac_sv.ts \
                src/qt/locale/fac_vi.ts \
                src/qt/locale/fac_zh_CN.ts \
                src/qt/locale/fac_zh_TW.ts

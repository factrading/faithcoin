...
In order to support loading of multiple wallets in fac-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is fac.cpp.
...
Changes to fac.cpp
----------------------
fac.cpp is the entry point into fac-qt, and as such, will require some minor modifications to provide hooks for

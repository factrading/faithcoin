...
This mechanism has been integrated into Bitcore-Node-Fac which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/fac-crypto/insight-api-fac#web-socket-api](https://github.com/fac-crypto/insight-api-fac#web-socket-api) 
* API: [https://github.com/fac-crypto/insight-api-fac#swifttx-transactions](https://github.com/fac-crypto/insight-api-fac#swifttx-transactions) 
...
By default, the Fac Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Fac Core daemon:

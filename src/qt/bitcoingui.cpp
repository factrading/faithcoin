                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    GUIUtil::restoreWindowGeometry("nWindow", QSize(800, 400), this);
    ...
    QString windowTitle = tr("Fac Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Fac address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and fac: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Fac Core"), this);
    aboutAction->setStatusTip(tr("Show information about Fac Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Fac"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Fac addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Fac addresses"));
    ...
    openAction->setStatusTip(tr("Open a Fac: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Fac Core help message to get a list with possible Fac command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Fac Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Fac network", "", count));
}
...
{
    QString strTitle = tr("Fac Core"); // default title

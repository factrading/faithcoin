...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Pivx features */
        {"fac", "masternode", &masternode, true, true, false},
        {"fac", "listmasternodes", &listmasternodes, true, true, false},
        {"fac", "getmasternodecount", &getmasternodecount, true, true, false},
        {"fac", "masternodeconnect", &masternodeconnect, true, true, false},
        {"fac", "masternodecurrent", &masternodecurrent, true, true, false},
        {"fac", "masternodedebug", &masternodedebug, true, true, false},
        {"fac", "startmasternode", &startmasternode, true, true, false},
        {"fac", "createmasternodekey", &createmasternodekey, true, true, false},
        {"fac", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"fac", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"fac", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"fac", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"fac", "getmasternodescores", &getmasternodescores, true, true, false},
        {"fac", "mnbudget", &mnbudget, true, true, false},
        {"fac", "preparebudget", &preparebudget, true, true, false},
        {"fac", "submitbudget", &submitbudget, true, true, false},
        {"fac", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"fac", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"fac", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"fac", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"fac", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"fac", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"fac", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"fac", "checkbudgets", &checkbudgets, true, true, false},
        {"fac", "mnsync", &mnsync, true, true, false},
        {"fac", "spork", &spork, true, true, false},
        {"fac", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"fac", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use facd, or the -server option to fac-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> fac-cli " + methodname + " " + args + "\n";
}
